...
Welcome to ``pycsd`` contributor's guide.
...
If you experience bugs or general issues with ``pycsd``, please have a look
...
You can help improve ``pycsd`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pycsd`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pycsd``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pycsd python=3 six virtualenv pytest pytest-cov
    conda activate pycsd
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pycsd.git
    cd pycsd
...
#. Install |pre-commit|_::
   ...
   ``pycsd`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pycsd
.. _issue tracker: https://github.com/<USERNAME>/pycsd/issues
.. <-- end -->
